...
if (!isset($_COOKIE[$flagCookieName])) {
    ...
    setcookie($flagCookieName, 'flag_cookie_task_23432', time() + 36000, "/"); // Cookie expires in 10 hours
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (strtolower($answer) === strtolower('5d4894be1d1ed45aae3b8bb1b2a1b4f6ba420ac647ff1bcace95952ac2881b96')) {
        // Mark task as completed by storing the completion code in session
        $_SESSION['task6_completed'] = $completionKey;
        $taskCompleted = true;
...
<head>
    ...
    <title>Task 6 - Guess the Certificate Name</title>
    <style>
        body {
...
<body>
    ...
    <div class="container">
        <h1>Task 6: Find the Certificate hash for <a href="https://inmumvm03293142.corp.capgemini.com/ctf-webapp/pages/leaderboard.php" target="_blank" >link</a></h1>
        ...
        <form method="POST">
            <label for="answer">Clue: Find the certificate used for signing this page and enter the Certificate hash.</label>
            <input type="text" name="answer" id="answer" placeholder="" required>
