...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (strtolower($answer) === 'permissions-policy') {
        // Mark task as completed by storing the completion code in session
        $_SESSION['task2_completed'] = $completionCode;
        $taskCompleted = true;
...
<head>
    ...
    <title>Task 2 - Guess the Header</title>
    <style>
        body {
...
<body>
    ...
    <div class="container">
        ...
        <form method="POST">
            <label for="answer" style="font-size: 1.1em;"> The security team has mandated that the application must block webpage access to the microphone, camera, and location. Which security header enforces this restriction?</label>
	    <input type="text" name="answer" id="answer" placeholder="***mi***o**-****cy" required>
