...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (strtolower($answer) === 'flag{smb_file_share_2393d4}') {
        // Mark task as completed by storing the completion code in session
        $_SESSION['task5_completed'] = $completionCode;
        $taskCompleted = true;
...
<head>
    ...
    <title>Task 5 - Find the Flag</title>
    <style>
        body {
...
<body>
    ...
    <div class="container">
        ...
        <form method="POST">
            <p style="font-size: 1.1em;">Clue: System administrators often leave this port open, making sensitive information accessible to everyone. </p>
            <input type="text" name="answer" id="answer" placeholder="flag{smb_****_*****_******}" required >
